            ...
            <Card>
                ...
                >
                    ...
                    <Collapse in={open} timeout="auto" unmountOnExit>
                        <ListItem>
                            <ListItemText primary="Total Products Score" />
                            {`${resume.totalProductScore?.toFixed(2)}%`}
                        </ListItem>
                        <ListItem>
                            <ListItemText primary="Total Sku Score" />
                            {`${resume.totalSkuScore?.toFixed(2)}%`}
                        </ListItem>
                        <ListItem>
                            <ListItemText primary="Total Score" />
                            {`${resume.totalScore?.toFixed(2)}%`}
                        </ListItem>
                    </Collapse>
                </List>
            </Card>
